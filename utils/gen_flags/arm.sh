...
arch_arm_fpu=$(kconfig_enum CONFIG_ARCH_ARM_FPU_VFPV2 -mfpu=vfpv2 CONFIG_ARCH_ARM_FPU_VFPV3_D16 -mfpu=vfpv3-d16 CONFIG_ARCH_ARM_FPU_VFPV4 -mfpu=vfpv4 CONFIG_ARCH_ARM_FPU_NEON -mfpu=neon)
